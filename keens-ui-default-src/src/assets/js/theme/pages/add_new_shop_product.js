...
var AddNewShopProduct = function () {    
    ...
    var save = function() {
        ...
        // Handles 
		$('#new_shop_product_save_default').click(function() {            
            $('#add_new_shop_product_form').submit();
        });
    ...
    var initValidation = function () {
        validator = $( "#add_new_shop_product_form" ).validate({
