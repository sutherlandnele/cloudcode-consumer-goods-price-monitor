                ...
                <div class="kt-portlet" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Edit Good Details</h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-brand" id="edit_product_save_default">
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form kt-form--label-right" id="edit_product_form" action="<?php echo base_url('Product/update');?>" method="post">                  
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    <h3 class="kt-section__title kt-section__title-lg"><?php echo $product->size.' '.$product->name; ?></h3>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6 form-group-sub">
                                            <label>* Name</label>
                                            <input type="text" id="name" value="<?php echo $product->name; ?>" name="input_val[name]" class="form-control" placeholder="Enter name of good">
                                            <input type="hidden" name="id" value="<?php echo $product->id; ?>" />   
                                            <span class="form-text text-muted">Please enter the name of the good.</span>
                                        </div>
                                        <div class="col-lg-6 form-group-sub">
                                            <label>* Good Category</label>
                                            <?php echo form_dropdown('input_val[product_category_id]', $dd_product_categories, $product->product_category_id,'id="product_category_id" class="form-control"'); ?>
                                                ...
                                                <div class="kt-section__body">
                                                    <div class="row form-group">
                                                        <div class="col-lg-12 form-group-sub">
                                                            ...
                                                            <input type="text" id="size" name="input_val[size]" value="<?php echo $product->size; ?>" class="form-control" placeholder="Enter size of good. Eg. 10kg">                     
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea class="form-control" id="description" name="input_val[description]"  rows="3"><?php echo $product->description; ?></textarea>
                                        ...
                                        <div class="col-lg-6">
                                            <?php if ($product->image) : ?>
                                                <script type="text/javascript">
                                                    window.g_product_image = "<?php echo $product->image; ?>";
                                                </script>
                                            <?php endif;?> 
