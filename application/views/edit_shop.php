                ...
                <div class="kt-portlet" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Edit Shop Details</h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-brand" id="edit_shop_save_default">
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form kt-form--label-right" id="edit_shop_form" action="<?php echo base_url('Shop/update');?>" method="post">                  
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="col-lg-6 form-group-sub">
                                        <label>* Name</label>
                                        <input type="text" id="name" value="<?php echo $shop->name; ?>" name="input_val[name]" class="form-control" placeholder="Enter name of shop">
                                        <input type="hidden" name="id" value="<?php echo $shop->id; ?>" />   
                                        <span class="form-text text-muted">Please enter the name of the shop.</span>
                                    </div>
                                    <div class="col-lg-6 form-group-sub">
                                        <label>* City</label>
                                        <?php echo form_dropdown('input_val[city_id]', $dd_cities,$shop->city_id,'id="city_id" class="form-control"'); ?>
                                ...
                                <div class="form-group row">                                    
                                    <div class="col-lg-6 form-group-sub">
                                        ...
                                        <input type="text" id="location_latitude" value="<?php echo $shop->location_latitude; ?>" name="input_val[location_latitude]" class="form-control" placeholder="-9.482372">
                                    ...
                                    <div class="col-lg-6 form-group-sub">
                                        ...
                                        <input type="text" id="location_longtitude" value="<?php echo $shop->location_longtitude; ?>" name="input_val[location_longtitude]" class="form-control" placeholder="147.207273">
                                ...
                                <div class="form-group row">                                    
                                    <div class="col-lg-6">
                                        <label>Website</label>
                                        <input type="text" id="website" value="<?php echo $shop->website; ?>" name="input_val[website]" class="form-control" placeholder="Enter the website url">
                                        <span class="form-text text-muted">Please the website url of the shop (example: www.shopname.com.pg)</span>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Brief Description</label>
                                        <textarea class="form-control" id="description" name="input_val[description]" placeholder="Description..."  rows="3"><?php echo $shop->description; ?></textarea>                                        
