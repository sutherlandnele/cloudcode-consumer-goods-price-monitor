...
class Tools_Model extends CI_Model {  
    ...
    public function get_quick_search_results()
    {
       
        return '<div class="kt-quick-search__result">
                ...
                <div class="kt-quick-search__section">
                    ...
                    <div class="kt-quick-search__item">
                        <div class="kt-quick-search__item-img kt-quick-search__item-img--file">
                            <img src="'.base_url().'assets/media/files/xml.svg" alt="" />
                        </div>
                        <div class="kt-quick-search__item-wrapper">
                            <a href="#" class="kt-quick-search__item-title">
                                AirPlus Requirements
                ...
                <div class="kt-quick-search__section">
                    <div class="kt-quick-search__item">
                        <div class="kt-quick-search__item-img">
                            <img src="'.base_url().'assets/media/users/300_14.jpg" alt="" />
                        </div>
                        <div class="kt-quick-search__item-wrapper">
                            <a href="#" class="kt-quick-search__item-title">
                                                Jimmy Curry
                    ...
                    <div class="kt-quick-search__item">
                        <div class="kt-quick-search__item-img">
                            <img src="'.base_url().'assets/media/users/300_20.jpg" alt="" />
                        </div>
                        <div class="kt-quick-search__item-wrapper">
                            <a href="#" class="kt-quick-search__item-title">
                                                Milena Gibson
                    ...
                    <div class="kt-quick-search__item">
                        <div class="kt-quick-search__item-img">
                            <img src="'.base_url().'assets/media/users/300_2.jpg" alt="" />
                        </div>
                        <div class="kt-quick-search__item-wrapper">
                            <a href="#" class="kt-quick-search__item-title">
                                                Anna Strong
